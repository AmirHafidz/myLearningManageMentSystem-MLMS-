@include('user.trainer.enter_course.task.hero')
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.tasks.forEach(element => {
                    ...
                    $('#task_tab').append(`@include('user.trainer.enter_course.content.task_content')`);
                    ...
                    element.task_detail.file.forEach(task_p => {
                        ...
                        // $($('[task_file_iterator=1]')).append(' <a href="'+path+'" download="'+file_downloaded+'" id="task_image_tag" task_image_tag_iterator=1>\
                        //                                             <img src="'+path+'" alt="" class="img-thumbnail" style="width: 100px" id="task_image_tag" task_image_iterator=1>\
                        //                                         </a>');
